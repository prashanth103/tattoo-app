...
export const artists: Artist[] = [
  ...
  },
  {
    ...
    reviews: 302,
    experience: "10 years",
    bio: "Amara's background in oil painting shows in every piece — soft shadow work and photographic detail that reads like portraiture rather than tattooing.",
    avatar: img("artist-amara", 400, 400),
    cover: img("artist-amara-cover", 1200, 800),
    portfolio: [3, 9, 15, 21],
    studio: "The Atelier",
    featured: true,
  },
  {
    ...
    slug: "theo-marchetti",
    name: "Theo Marchetti",
    speciality: "Geometric & Dotwork",
    location: "Florence, Italy",
    rating: 4.9,
    reviews: 176,
    experience: "9 years",
    bio: "Theo builds symmetrical, mathematically precise compositions freehand, treating every session as a study in structure and sacred geometry.",
    avatar: img("artist-theo", 400, 400),
    cover: img("artist-theo-cover", 1200, 800),
    portfolio: [4, 10, 16, 22],
    studio: "Numero Tattoo Co.",
    featured: true,
  },
  {
    id: 5,
    ...
    reviews: 154,
    experience: "11 years",
    bio: "Nadia keeps the old-school flash tradition alive with bold, confident linework and a palette built to age gracefully for decades.",
    avatar: img("artist-nadia", 400, 400),
    cover: img("artist-nadia-cover", 1200, 800),
    portfolio: [5, 11, 17, 23],
    studio: "Iron & Ivy",
  },
  {
    id: 6,
    ...
    reviews: 141,
    experience: "7 years",
    bio: "Kai reworks traditional motifs through a contemporary, illustrative lens — vivid color stories built around folklore and nature.",
    avatar: img("artist-kai", 400, 400),
    cover: img("artist-kai-cover", 1200, 800),
    portfolio: [6, 12, 18, 24],
    studio: "Kuro Ink Studio",
  },
  {
    id: 7,
    slug: "sofia-reyes",
    name: "Sofia Reyes",
    speciality: "Watercolor & Illustrative",
    location: "Barcelona, Spain",
    rating: 4.9,
    reviews: 198,
    experience: "6 years",
    bio: "Sofia paints before she tattoos — literally. Every design begins as a watercolor study before it's translated onto skin.",
    avatar: img("artist-sofia", 400, 400),
    cover: img("artist-sofia-cover", 1200, 800),
    portfolio: [1, 2, 3, 4],
    studio: "Studio Marea",
  },
  {
    ...
    slug: "jonas-berg",
    name: "Jonas Berg",
    speciality: "Blackwork & Tribal",
    location: "Stockholm, Sweden",
    rating: 4.6,
    reviews: 122,
    experience: "13 years",
    bio: "Jonas draws on Nordic pattern history to build heavy, high-contrast blackwork pieces designed to move with the body.",
    avatar: img("artist-jonas", 400, 400),
    cover: img("artist-jonas-cover", 1200, 800),
    portfolio: [5, 6, 7, 8],
    studio: "Svart Studio",
  },
];
