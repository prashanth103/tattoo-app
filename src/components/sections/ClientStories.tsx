        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-body text-text-secondary text-lg">
              {GOOGLE_REVIEWS.total} Reviews
            </span>
          </div>

          <div className="font-display text-[56px] md:text-[64px] mb-4 leading-none">
            {GOOGLE_REVIEWS.rating} / 5
          </div>

          <div className="flex items-center justify-center gap-3 mb-8">
            <GoogleIcon className="w-6 h-6" />
            <p className="text-text-muted font-body text-sm md:text-base tracking-wide uppercase">
              Based on {GOOGLE_REVIEWS.total} Google Reviews
            </p>
          </div>
